...
COLOR_PREFIXES = (
  ...
  "Mono White", "Mono Blue", "Mono Black", "Mono Red", "Mono Green",
  "Mono-W", "Mono-U", "Mono-B", "Mono-R", "Mono-G",
  "Azorius", "Orzhov", "Boros", "Selesnya", "Dimir", "Izzet", "Rakdos",
  "Golgari", "Gruul", "Simic", "Jeskai", "Grixis", "Jund", "Naya",
  "Bant", "Abzan", "Sultai", "Mardu", "Temur", "Esper", "White", "Blue",
  "Black", "Red", "Green", "Colorless", "Snow", "WUBRG", "WBRG", "WURG",
  "WUBG", "WUBR", "UBRG", "4/5c", "4c", "5c", "WUR", "UBR", "BRG",
  "WRG", "GWU", "WBG", "UBG", "WBR", "URG", "WUB", "WUG", "WU", "WB",
  "WR", "WG", "UB", "UR", "BR", "BG", "RG", "GR", "UG", "W", "U", "B", "R",
  "G", "C", "S",
)
...
def build_family_mapping(
  ...
  *,
  ...
  for label_id, display_label in label_by_id.items():
    ...
    ids_by_relaxed_name[relaxed_archetype_name(display_label).casefold()].append(
      label_id
    )
  ...
  for members in members_by_root.values():
    names = Counter(
      relaxed_archetype_name(label_by_id[label_id])
